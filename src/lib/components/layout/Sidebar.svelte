<script lang="ts">
	...
	import Assignment from '../icons/Assignment.svelte';
	...
	>
		...
		>
			...
			<div>
				...
				<div class="">
					<Tooltip content={$i18n.t('Assignments')} placement="right">
						<a
							class=" cursor-pointer flex rounded-xl hover:bg-gray-100 dark:hover:bg-gray-850 transition group"
							href="/assignments"
							on:click={async (e) => {
							...
							draggable="false"
							aria-label={$i18n.t('Assignments')}
						>
							<div class=" self-center flex items-center justify-center size-9">
								<Assignment className="size-4.5" />
							</div>
						</a>
					</Tooltip>
				</div>
		...
		>
			...
			>
				<div class="pb-1.5">
					...
					<!-- Assignments Menu Item (Expanded) -->
					<div class="px-[7px] flex justify-center text-gray-800 dark:text-gray-200">
						<a
						...
						>
							<div class="self-center">
								<Assignment className="size-4.5" strokeWidth="2" />
							</div>

							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">{$i18n.t('Assignments')}</div>
							</div>
						</a>
					</div>
